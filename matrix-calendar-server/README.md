...
There are two ways to setup the Matrix Calendar widget using the bot:
...
- `!meeting detail` Show the manual about Matrix Calendar widget setup in the room
- `!meeting setup` Adds a Matrix Calendar widget to the room
- `!meeting status` Check the ability to add the Matrix Calendar widget
